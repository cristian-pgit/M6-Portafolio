...
DROP TABLE IF EXISTS `autorities`;
...
--
-- Dumping data for table `autorities`
--

LOCK TABLES `autorities` WRITE;
/*!40000 ALTER TABLE `autorities` DISABLE KEYS */;
INSERT INTO `autorities` VALUES (1,'ADMIN'),(2,'READ'),(3,'WRITE');
/*!40000 ALTER TABLE `autorities` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_authority` (
  ...
  KEY `FK8yqr427nvity54okkwmhal4wy` (`authorities_id`),
  KEY `FKhi46vu7680y1hwvmnnuh4cybx` (`user_id`),
  CONSTRAINT `FK8yqr427nvity54okkwmhal4wy` FOREIGN KEY (`authorities_id`) REFERENCES `autorities` (`id`),
...
INSERT INTO `users` VALUES (1,'UncleDave123','uncledave'),(2,'User0123','user01'),(3,'User0123','user02');
...
-- Dump completed on 2023-05-08 13:48:28
