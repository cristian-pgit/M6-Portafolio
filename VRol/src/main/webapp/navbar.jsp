...
<nav class="navbar navbar-expand-lg bg-body-tertiary"
	...
	<div class="container-fluid">
		<img src="Assets\img\LogoVrol.png" alt="Logo" width="30" height="24"
			class="d-inline-block align-text-top" id="logohead"> <a
			class="navbar-brand" href="index.jsp">&nbsp;Comunidad VROL</a>
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" href="juegos.html">Juegos</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="calendario.html">Calendario</a>
				</li>
				...
				<li class="nav-item"><a class="nav-link"
					href="mailto:oficialvrol@gmail.com">Contacto</a></li>
			</ul>
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
