...
<c:forEach var="mesa" items="${requestScope.mesas}">
	<div class="card border-info mb-3" style="max-width: 20rem;">
	  <div class="card-header"><c:out value="${mesa.juego}" /></div>
	  <div class="card-body">
	    <h4 class="card-title"><c:out value="${mesa.nombreMesa}" /></h4>
	    <p class="card-text"><strong>Narrador:</strong>&nbsp;<c:out value="${mesa.narrador}" /></p>
	    <p class="card-text">Cantidad de Jugadores:&nbsp;<c:out value="${mesa.jugadores}" /></p>
	    <p class="card-text"><strong>Fecha:</strong>&nbsp;<c:out value="${mesa.dia}" /></p>
	    <p class="card-text"><strong>Descripcion:</strong>&nbsp;<c:out value="${mesa.desCorta}" /></p>
	    <p class="card-text"><strong>Tags:</strong>&nbsp;<c:out value="${mesa.tags}" /></p>
	  </div>
	</div>
</c:forEach>
